...
# --- VAIHE 1: DATAN LATAUS JA LABELIEN VALMISTELU ---
...
# Muutetaan teksti-labelit numeroiksi
le = LabelEncoder()
...
# --- VAIHE 3: MALLIN RAKENTAMINEN JA GRID SEARCH ---

# Putken rakennus (Huom: SMOTE ja skaalaus oikeassa järjestyksessä)
...
# Parametrien määrittely sparrauksen perusteella
param_grid = {
    'scaler': [StandardScaler(), MinMaxScaler()],
    'poly__degree': [1, 2],
    'dim_red': [PCA(n_components=5), 'passthrough'], # LDA jätetty pois tästä simppeliyden vuoksi, voit lisätä
    'smote': [SMOTE(random_state=42), 'passthrough'],
    'classifier__C': [0.1, 1, 10]
}

print("Aloitetaan GridSearchCV... Tämä voi kestää useita minuutteja.")
...
# Testataan parasta mallia validaatiodatalla
